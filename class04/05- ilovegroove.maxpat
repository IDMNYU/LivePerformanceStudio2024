...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.000003159046173, 224.666673362255096, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 188.000005602836609, 41.0, 22.0 ],
					"text" : "loop 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.5, 440.5, 258.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 633.5, 148.0, 61.0, 20.0 ],
					"style" : "helpfile_label",
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 529.75, 148.0, 94.0, 20.0 ],
					"style" : "helpfile_label",
					"text" : "select end ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.0, 148.0, 94.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.75, 148.0, 111.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 173.0, 148.0, 101.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 25.0, 368.0, 136.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 429.0, 44.0, 44.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 635.5, 168.0, 57.0, 23.0 ],
					"text" : "0 -1 0 -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.5, 339.333344000000011, 107.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.25, 368.0, 82.0, 23.0 ],
					"text" : "import 0 -1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.5, 293.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 395.5, 293.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.5, 293.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.5, 293.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 120.0, 40.0, 23.0 ],
					"text" : "undo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 550.75, 168.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 433.0, 168.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.25, 168.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.5, 168.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.0, 258.5, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 25.0, 293.5, 44.0, 23.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 25.0, 326.333344000000011, 102.0, 23.0 ],
					"text" : "groove~ foo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.5, 368.0, 51.0, 23.0 ],
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 183.5, 409.0, 158.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 322.5, 439.5, 61.0, 23.0 ],
					"text" : "set foo 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 197.5, 197.0, 490.0, 93.0 ],
					"setmode" : 2,
					"ticks" : 8,
					"vlabels" : 1
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 645.0, 194.0, 678.0, 194.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-68", 0 ],
					"midpoints" : [ 332.0, 475.0, 169.0, 475.0, 169.0, 186.0, 207.0, 186.0 ],
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 489.600000000000023, 308.666687000000024, 117.5, 308.666687000000024 ],
					"order" : 1,
					"source" : [ "obj-68", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 395.399999999999977, 300.666687000000024, 76.0, 300.666687000000024 ],
					"order" : 1,
					"source" : [ "obj-68", 2 ]
				}
